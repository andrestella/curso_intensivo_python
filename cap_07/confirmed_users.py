...
# Observação: Um laço 'for' é eficiente para percorrer uma lista, mas você
# não deve modificar uma lista em um laço 'for', pois Python terá problemas em
# manter o controle dos itens da lista. Para modificar uma lista enquanto 
# trabalhar com ela, utilize um laço 'while'. Usar laços 'while' com listas
# e dicionários permite coletar, armazenar e organizar muitas entradas a fim
